    ...
    return (
        <div className="">
            <div className="mx-auto max-w-2xl mt-12 sm:mt-2 px-4 py-0 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
                <div className="bg-white rounded-xl sm:py-20 grid grid-cols-1 lg:grid-cols-5 gap-4">
                    ...
                    {/* Right section */}
                    <div className="col-span-3 ms-14 px-16 bg-gray-0 border-l-2 border-gray-200">
                        <div className="flex flex-wrap justify-between gap-x-24 gap-y-16">
                            <div>
                                <DocumentCheckIcon className='w-12 h-12 text-gray-700 bg-gray-300 p-2 rounded-full' />
                                <p className='text-gray-900 font-bold w-20 '>Location Confirmation</p>
                            </div>
                            <div>
                                <FingerPrintIcon className='w-12 h-12 text-gray-700 bg-gray-300 p-2 rounded-full' />
                                <p className='text-gray-900 font-bold w-28'>Passcode and Touch ID</p>
                            </div>
                            <div>
                                <ChatBubbleBottomCenterTextIcon className='w-12 h-12 text-gray-700 bg-gray-300 p-2 rounded-full' />
                                <p className='text-gray-900 font-bold w-28'>Instant Alerts</p>
                            </div>
                            <div>
                                <ChatBubbleLeftEllipsisIcon className='w-12 h-12 text-gray-700 bg-gray-300 p-2 rounded-full' />
                                <p className='text-gray-900 font-bold w-28'>Messages Editing</p>
                            </div>
                            <div>
                                <ArrowTrendingUpIcon className='w-12 h-12 text-gray-700 bg-gray-300 p-2 rounded-full' />
                                <p className='text-gray-900 font-bold w-28'>Data Tracking</p>
                            </div>
                            <div>
                                <CircleStackIcon className='w-12 h-12 text-gray-700 bg-gray-300 p-2 rounded-full' />
