            ...
            <div className="mx-auto max-w-2xl mt-12 sm:mt-2 px-4 py-0 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
                <div className="sm:py-6 grid grid-cols-1 lg:grid-cols-5 gap-4">
                    ...
                    <div className="col-span-2 bg-gray-0">
                        <div className=" px-16 flex justify-center items-center space-x-16">
                    ...
                    {/* Right section */}
                    <div className="col-span-3 ms-14 pe-16 bg-gray-0">
                        <p className="text-gray-900 opacity-90  text-lg font-normal leading-7">
