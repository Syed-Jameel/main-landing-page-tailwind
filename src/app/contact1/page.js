                            ...
                            <div className="bg-gray-0">
                                <div className="bg-white rounded-none sm:rounded-lg px-4  py-10 sm:p-10">
                                    <div className="space-y-6">
                                        <h6 className="mb-3 text-gray-900 text-lg font-bold flex justify-start">Address</h6>
                                        <div className="mb-2 space-y-4">
                                            <div className="text-gray-600 text-base">
                                                <span className="text-gray-900  font-bold">Barcelona</span>
                                        ...
                                        <h6 className="mb-2 text-gray-900 text-lg font-bold flex justify-start">Ph: +3.230.705.5448</h6>
                                        <div className="mb-3 space-y-1">
                                            <h6 className="text-gray-900 text-base font-bold">Assistance hours:</h6>
                                            <div className="text-gray-600 text-base">
                                                <span> Monday – Friday.</span>
                                                <div>
                                                    6 am to 8 pm EST (toll free)
                                                </div>
                                            </div>
                                        </div>
                                        <button className="bg-red-600 transition duration-500 hover:bg-blue-700 text-white text-lg font-semibold py-3 px-4 rounded">Send Us an Email</button>
                                    </div>
                                </div>
                            </div>
